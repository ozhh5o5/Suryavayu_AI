...
export default function ModelsPage() {
  const models = [...DATA.models].sort((a, b) => new Date(b.trainedAt).getTime() - new Date(a.trainedAt).getTime());
  ...
  return (
    <div className="space-y-6">
      ...
      <Card>
        ...
        <button disabled className="mt-4 rounded bg-orange-600 px-3 py-2 text-sm font-semibold text-white hover:bg-orange-700 opacity-50 cursor-not-allowed">
          Retrain on latest data (Disabled in SPA)
        </button>
      </Card>
